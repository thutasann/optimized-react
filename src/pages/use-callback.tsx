...
import { ListData } from '../util/static'
...
const UseCallBack = () => {
  ...
  return (
    <div>
      <Heading text='Use callback' description='In this section, Use Callback hook will be applied to optimize the Heavy Functions.' />
      <Button text='Increase Count' onClick={() => setCount(count + 1)} />
      <p>Count is {count}</p>
      <div className='mt-4 border-t border-gray-600 pt-3'>
        <TodoList todos={todo} deleteItem={deleteItem} />
      </div>
    </div>
  )
}

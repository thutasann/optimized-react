...
const Home = () => {
  return (
    <div className='h-full overflow-y-hidden w-full flex items-center justify-center flex-col gap-[20px]'>
      ...
      <p className='text-xl text-center'>This site contains Optimization Techniques for React, React Hook and React Redux.</p>
      <Link
        to={SideBarData[1].link}
      ...
      >
        Let Get Started <BsArrowRightCircleFill size={19} className='group-hover:ml-2 transition-all duration-300 ease-in-out' />
      </Link>
    </div>
  )
}
